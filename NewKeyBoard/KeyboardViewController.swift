...
//        secondRowView.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
    ...
    func serveiceKeys(midRow: UIView)->(UIStackView, UIStackView) {
        self.capButton = accessoryButtons(title: nil, img: UIImage(named: "captial1"),tag: 10)
        ...
        self.nextKeyboardButton = accessoryButtons(title: nil, img: UIImage(named:  "globe"), tag: 4)
        self.rupeSoButton = accessoryButtons(title: nil, img: UIImage(named:  "RupeSoKey"), tag: 5)
